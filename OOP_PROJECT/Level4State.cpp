...
void Level4State::setPlantFactoryTextures(AssetManager& Assets)
{
...
void Level4State::setZombieTextures(AssetManager& Assets)
{
...
void Level4State::handleAllPlantsCreation(sf::RenderWindow& window)
{
...
void Level4State::spawnZombies()
{
	...
	const int zombieTypes[numWaves][4] = { {1}, {1, 2, 3, 4} };
...
void Level4State::renderPlantFactory(sf::RenderWindow& window)
{
...
void Level4State::renderZombies(sf::RenderWindow& window, float deltaTime)
{
...
void Level4State::renderUI(sf::RenderWindow& window)
{
...
void Level4State::generateSuns(sf::RenderWindow& window, float deltaTime)
{
	for (int i = 0; i < 5; i++)
	{
...
void Level4State::handleSunCollection(sf::RenderWindow& window)
{
...
void Level4State::handlePlantRemoval(sf::RenderWindow& window)
{
...
void Level4State::handleBulletZombieCollision(sf::RenderWindow& window)
{
...
void Level4State::handlePlantZombieCollision()
{
	for (int i = 0; i < 4; ++i) // Iterate over shooter types
	{
		for (int j = 0; j < totalShooterInstancesCreated; ++j) // Iterate over shooter instances
...
void Level4State::handleLawnMowerCollision(float deltaTime)
{
...
void Level4State::Init(AssetManager& Assets)
{
...
void Level4State::HandleInput(StateMachine* machine, sf::RenderWindow& window)
{
...
void Level4State::Update(StateMachine* machine, float deltaTime)
{
	int shooterPlanttypes = 4;
	// For plant factory
	for (int k = 0; k < shooterPlanttypes; k++)
	...
	Level4State::spawnZombies();
	Level4State::handleLawnMowerCollision(deltaTime);
